  ...
  return (
    <div className="ml-28 mt-2 flex gap-6">
            ...
            <div className="flex justify-between items-center">
              <div className="flex gap-3">
                <div>
                  <div className="flex items-center gap-2">
                    <div className="font-xl font-semibold cursor-pointer">
                      {channelTitle}
                    </div>
                  ...
                  <div>
                    <div className="text-sm text-gray-500">
                      {convertCounts(viewCount) + " subscribers"}
                    </div>
                  </div>
                </div>
                <div className="bg-black text-white rounded-full px-5 py-2 self-center font-semibold">
                  {" "}
                  Subscribe{" "}
                </div>
              </div>
              <div className="flex gap-5 mr-16">
                <div className="bg-gray-100 px-4 py-1 flex gap-2 align-center rounded-full cursor-pointer">
                  ...
                  <div className="font-semibold relative top-1 pr-2">
                    {convertCounts(likeCount)}
                  </div>
                ...
                <div className="rounded-full bg-gray-100 px-3.5 text-xl font-semibold cursor-pointer">
                  {"..."}
                </div>
              </div>
            </div>
      ...
      <div className=" w-full p-3 relative ">
        ...
        <LiveChat />
        <form
          className="w-full my-2 flex border border-gray-200 rounded-2xl relative"
          onSubmit={(e) => {
            e.preventDefault();
          }}
        >
          <input
            type="text"
            className="w-10/12 py-2 px-4 rounded-2xl select-none outline-none"
          ...
          />
          <button
            className="py-2 px-4 bg-gray-200 rounded-2xl absolute right-0"
            onClick={() => {
              dispatch(
                addMessage({
                  name: "Shiva Sai",
